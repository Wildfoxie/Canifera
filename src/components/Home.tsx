...
export default function HomePage({ onArticleClick, onMealClick, onAddToCart, onExploreClick, petName }: HomePageProps) {
  return (
    <div className="space-y-6">
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <div className="flex items-center gap-1 text-amber-500 dark:text-[#eba434] text-[10px] font-bold">
      ...
      <section className="grid grid-cols-2 gap-4">
        ...
        <div className="bg-amber-50 dark:bg-amber-50/10 p-4 rounded-3xl border border-amber-100 dark:border-amber-100/20 flex flex-col gap-2">
          <div className="w-10 h-10 bg-white dark:bg-slate-700 rounded-2xl flex items-center justify-center shadow-sm">
            <Star className="text-amber-600 dark:text-[#eba434]" size={20} />
          </div>
          <div>
            <p className="text-xs font-bold text-amber-800 dark:text-[#eba434] uppercase tracking-widest">Quality</p>
            <p className="text-sm text-amber-600 dark:text-[#eba434] font-medium">Premium Sourcing</p>
          </div>
        </div>
      </section>
    </div>
