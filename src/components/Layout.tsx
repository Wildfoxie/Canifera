...
export default function Layout({ 
  ...
  const titleImageSrc = title === 'Canifera' ? '/imgs/title_logo.png' : null;
      ...
      <header className="bg-white border-b border-slate-100 px-6 py-4 flex items-center justify-between sticky top-0 z-20">
        <div className="flex items-center gap-2">
          {showBack ? (
            ...
            <div className="w-10 h-8 rounded-lg flex items-center justify-center text-white">
              <img 
                src="/imgs/logo.png" 
                alt="Canifera Logo" 
  ...
  return (
    ...
    >
      <div className={cn(
        ...
        {React.cloneElement(icon as React.ReactElement, { size: 22, strokeWidth: active ? 2.5 : 2 } as any)}
      </div>
